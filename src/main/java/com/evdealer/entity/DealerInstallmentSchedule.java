...
public class DealerInstallmentSchedule {
    ...
    public DealerInstallmentSchedule(DealerInstallmentPlan plan, Integer installmentNumber, LocalDate dueDate, BigDecimal amount) {
        this.plan = plan;
    ...
    public DealerInstallmentPlan getPlan() {
        return plan;
    }
