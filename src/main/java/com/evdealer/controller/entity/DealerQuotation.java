...
public class DealerQuotation {
    ...
    public DealerQuotation(String quotationNumber, com.evdealer.entity.Dealer dealer, DealerOrder dealerOrder, LocalDate quotationDate, BigDecimal totalAmount) {
