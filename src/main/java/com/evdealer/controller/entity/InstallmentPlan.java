...
public class InstallmentPlan {
    ...
    private com.evdealer.entity.Order order;
    ...
    private com.evdealer.entity.DealerInvoice invoice;
    
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "dealer_id", nullable = true)
    private com.evdealer.entity.Dealer dealer;
    ...
    public InstallmentPlan(com.evdealer.entity.Order order, com.evdealer.entity.Customer customer, BigDecimal totalAmount, BigDecimal downPaymentAmount, BigDecimal loanAmount, BigDecimal interestRate, Integer loanTermMonths, BigDecimal monthlyPaymentAmount) {
        this.order = order;
    ...
    public com.evdealer.entity.Order getOrder() {
        return order;
    }
    ...
    public com.evdealer.entity.DealerInvoice getInvoice() {
        return invoice;
    }
    ...
    public com.evdealer.entity.Dealer getDealer() {
        return dealer;
    }
