...
public class DealerDiscountPolicy {
    ...
    private com.evdealer.entity.VehicleVariant variant;
    ...
    public DealerDiscountPolicy(com.evdealer.entity.VehicleVariant variant, String policyName, LocalDate startDate, LocalDate endDate) {
    ...
    public com.evdealer.entity.VehicleVariant getVariant() {
        return variant;
    }
