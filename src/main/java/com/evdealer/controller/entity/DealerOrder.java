...
public class DealerOrder {
    ...
    private List<com.evdealer.entity.DealerOrderItem> items;
    ...
    private List<com.evdealer.entity.DealerQuotation> quotations;
    ...
    public DealerOrder(String dealerOrderNumber, com.evdealer.entity.Dealer dealer, com.evdealer.entity.User evmStaff, LocalDate orderDate, Integer totalQuantity, BigDecimal totalAmount) {
    ...
    public List<com.evdealer.entity.DealerOrderItem> getItems() {
        return items;
    }
    ...
    public List<com.evdealer.entity.DealerQuotation> getQuotations() {
        return quotations;
    }
