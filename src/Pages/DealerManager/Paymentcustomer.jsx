      ...
      {showDetail && selectedPayment && (
        <div className="popup-overlay">
          <div className="popup-box">
            ...
            <p><b>Khách hàng:</b> {selectedPayment.customer?.firstName && selectedPayment.customer?.lastName
              ? `${selectedPayment.customer.firstName} ${selectedPayment.customer.lastName}`.trim()
              : selectedPayment.customer?.firstName || selectedPayment.customer?.lastName || 'N/A'}</p>
