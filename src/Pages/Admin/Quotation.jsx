...
export default function Quotation() {
  ...
  // Lấy danh sách báo giá khách hàng (bao gồm cả báo giá từ DealerStaff)
  const fetchQuotations = async () => {
    try {
      setLoading(true);
      const res = await quotationAPI.getQuotations();
      console.log("📦 Raw response từ getQuotations (Admin):", res);
      const quotationsData = res.data?.data || res.data || [];
      console.log("📦 Customer Quotations data (Admin):", quotationsData);
      console.log("📦 Total quotations:", Array.isArray(quotationsData) ? quotationsData.length : 0);
      // Hiển thị TẤT CẢ quotations (bao gồm cả từ DealerStaff)
    ...
    <div className="customer">
      ...
      <div className="title2-customer">
        ...
        <small style={{ color: "#666", fontSize: "14px", display: "block", marginTop: "5px" }}>
          📋 Hiển thị tất cả báo giá (bao gồm cả báo giá từ DealerStaff)
        </small>
        {(isEVMStaff || isAdmin) && (
