...
import { 
  ...
  faComments, faFileContract, faBullseye, faFileSignature, faDollarSign, 
  faImages, faCalendarAlt, faListAlt, faFileInvoice 
 ...
 const toggleNotifications = () => {
  ...
  useEffect(() => {
    ...
    if (savedToken && savedUser && savedRole) {
      ...
      console.warn("⚠️ Admin: Không có đủ thông tin đăng nhập, redirect về login");
      navigate("/login", { replace: true });
    }
  }, [navigate]);
